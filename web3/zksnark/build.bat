...
if exist "%PTAU_FILE%" (
    ...
    snarkjs powersoftau new bn128 16 "%PHASE1_FILE%" -v
...
if exist "%BUILD_DIR%\proof.json" (
    ...
    node "%BUILD_DIR%\Main_js\generate_witness.js" "%BUILD_DIR%\Main_js\Main.wasm" "%INPUT_FILE%" "%BUILD_DIR%\witness.wtns"
